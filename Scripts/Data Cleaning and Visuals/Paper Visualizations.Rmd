...
output_file_path <- file.path(output_directory, "Images and Tables/Images", "table_descriptive_statistics_aids_relevancy_filtered.html")
...
output_file_path <- file.path(output_directory, "Images and Tables/Images", "table_top_terms_and_betas_(all_authors).html")
...
ggsave(file.path(output_directory, "Images and Tables/Images", "plot_co-occurrence_network.png"), 
...
output_file_path <- file.path(output_directory, "Images and Tables/Images", "table_descriptive_statistics_influential_authors.html")
...
# Correctly construct the output file path
output_file_path <- file.path(output_directory, "Images and Tables/Images", "table_descriptive_statistics_sentiment_scores_combined.html")
...
output_file_path <- file.path(output_directory, "Images and Tables/Images", "plot_time_series_sentiment_line_graph.png")
...
# Save the gt table to an HTML file
output_file_path <- file.path(output_directory, "Images and Tables/Images", "table_top_terms_and_betas_(influential_authors).html")
gtsave(gt_table, output_file_path)
```
...
output_file_path <- file.path(output_directory, "Images and Tables/Images", "table_topic_matches.html")
...
output_file_path_transposed <- file.path(output_directory, "Images and Tables/Images", "table_topic_matches_transposed.html")
...
ggsave(file.path(output_directory, "Images and Tables/Images", "plot_topic_influence_comparison_bar_graph.png"), 
...
output_file_path <- file.path(output_directory, "Images and Tables/Images", "plot_topic_prevalence_line_graph.png")
...
output_file_path <- file.path(output_directory, "Images and Tables/Images/plot_top_15_most_active_users_by_newsgroup.png")
...
# Save the plot
output_file_path <- file.path(output_directory, "Images and Tables/Images", "plot_keyword_adoption_over_time.png")
...
# Save the plot
output_file_path <- file.path(output_directory, "Images and Tables/Images", "plot_influence_propagation_network_improved.png")
...
network_graph_path <- file.path(output_directory, "Images and Tables/Images/new web visualizations/interactive_plot_3d_cooccurrence_network.html")
